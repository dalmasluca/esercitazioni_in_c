...
Completate il seguente programma (dopo aver copiato e incollato il codice in un file a cui date il nome `random.c`).
...
Salvare il seguente programma in un file chiamato `1a-for-ternario.c`, aggiungere come commento le *specifiche* del programma (cioè le indicazioni che dareste al programmatore che dovesse scriverlo).
```c
#include <stdio.h>
...
Salvare il seguente programma in un file chiamato `1b-for-ternario.c`, fare quanto indicato nei commenti.
...
Salvare il seguente programma in un file chiamato `1c-for-ternario.c`, aggiungere come commento le *specifiche* del programma, sostituire il nome della variabile `s` con un nome più significativo.
```c
#include <stdio.h>
...
Salvare il seguente programma in un file chiamato `1d-for-ternario.c`, fare quanto indicato nei commenti.
...
Salvare il seguente programma in un file chiamato `1prm-a-for-ternario.c`, aggiungere come commento le *specifiche* del programma.
...
Salvare il seguente programma in un file chiamato `1prm-b-for-ternario.c`, aggiungere come commento le *specifiche* del programma.
...
Salvare il seguente programma in un file chiamato `1exp-for-ternario.c`, aggiungere come commento le *specifiche* del programma.
...
---
### Es. 2a-while
Salvare il seguente programma in un file chiamato `2a-while.c`, aggiungere come commento le *specifiche* del programma, sostituire il nome della variabile `t` con un nome più significativo.
...
int main() {
    /*
    Scrivere qui le specifiche per questo programma, dare un nome più significativo alla variabile t
    */
    const int TARGET = 20;
    const int MAX = 10;
    srand(time(NULL));
...
### Es. 2b-while
Salvare il seguente programma in un file chiamato `2b-while.c`, aggiungere come commento le *specifiche* del programma, dare nomi più significativi alle variabili c, n, o.
...
### Es 3-ciclo-infinito
Salvare il seguente programma in un file chiamato `3-ciclo-infinito.c`, aggiungere come commento le *specifiche* del programma, sostituire il nome della variabile `c` con un nome più significativo.
```c
#include <stdio.h>
#include <stdlib.h>
#include <time.h>
...
Associa a ciascuna porzione di codice la descrizione corrispondente: copia le descrizioni riportate sotto in un file frammenti.txt, sostituendo per ciascuna la x con il numero della porzione di codice corrispondente.
